...
class Starting():
    def __init__(self, NB_Questions):
        self.Categories = {0: "Random", 9: 'General Knowledge', 10: 'Entertainment: Books', 11: 'Entertainment: Film',
              12: 'Entertainment: Music',
              13: 'Entertainment: Musicals & Theatres', 14: 'Entertainment: Television',
              15: 'Entertainment: Video Games', 16: 'Entertainment: Board Games',
              17: 'Science & Nature', 18: 'Science: Computers', 19: 'Science: Mathematics', 20: 'Mythology',
    ...
    def user_interaction(self, Chosen_Cat):
        self.Chosen_Cat = Chosen_Cat
        print("Hi, Welcome to Trivia Quiz!")
        ...
        while check_loop:
            ...
            try:
                print('You have chosen :', self.Categories[Chosen_Cat])
                check_loop = False
            except:
                check_loop = True
        ...
        self.url = "https://opentdb.com/api.php?amount=" + str(NB_Questions) + "&category=" + str(Chosen_Cat) + "&type=boolean"

    def retrieve_api(self, url, response_json):
...
for i in response_json['results']:
    new_question = Question(category=i['category'], q_type=i['type'], difficulty=i['difficulty'],
                            question=i['question'],
...
class Quiz:
    ...
    def next_question_easy(self):
        try:
            ...
            user_answer = input(
                f"{self.q_num_easy + self.q_num_medium + self.q_num_hard} {current_question.question} (True/False): ")
